...
{}. Give the answer in the form of a ranked list in json format.'''

base_prompt_with_expression = '''Select the elements of this list that best fit {}:

{}. Give the answer in the form of a ranked list in json format.'''

expression_prompt = 'What would be the expression / name that would best fit a {} that is {}? Give the answer in the form of a ranked list in json format.'
