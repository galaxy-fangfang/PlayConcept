...
def prompt_llama2(codes):
	...
	answer = ollama('''Select the one element of this list that best fit a "Location,Country,Flag" which is "Water,Liquid,Aquatic" and "Huge,Wider,Longer":
